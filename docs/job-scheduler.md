...
espresso*       up      20:00      1-2                10      0/28/0/28    0/1344/0/1344
```
...
espresso*       up      20:00     28   idle compute-0-[0-27]
```

`NODELIST` shows that the `espresso` partition has 28 nodes from `compute-0-0` to `compute-0-27`.
