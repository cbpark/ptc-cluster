...
espresso*       up      20:00      1-2                10      0/27/0/27    0/1280/0/1280
```
...
espresso*       up      20:00     27   idle compute-0-[0-26]
```

`NODELIST` shows that the `espresso` partition has 27 nodes from `compute-0-0` to `compute-0-26`.
