...
The users of the old PTC cluster system would be more familiar with Sun Grid Engine (SGE). Please refer to [SGE to SLURM conversion](https://srcc.stanford.edu/sge-slurm-conversion). A summary of commands and options is given [here](https://slurm.schedmd.com/pdfs/summary.pdf).
