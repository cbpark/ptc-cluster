...
espresso*       up      20:00      1-2                10      0/30/0/30    0/1472/0/1472
```
...
espresso*       up      20:00     30   idle compute-0-[0-29]
```

`NODELIST` shows that the `espresso` partition has 30 nodes from `compute-0-0` to `compute-0-29`.
